...
public class OrderPlasticDialog {
    TextView textViewPlasticPrice;
    ...
    public void showOrderPlasticDialog(Context context, String weight, String priceForKg, final String buyerId, final BuyerModel buyerModel,final OrderCreateSuccess interfaceSuccess) {
        ...
        textViewPlasticPrice = dialog.findViewById(R.id.mtv_price);
    ...
    private void saveData(final String buyerId,final BuyerModel buyerModel){
        ...
        String queryParameter = buyerId+"_"+userId+"_"+ WasteType.PLASTIC.toString() +"_"+ RequestStatus.ACTIVE.toString();
    ...
    private void priceCalculation(String totalWeight, String priceForOneKg){
        ...
        textViewPlasticPrice.setText(totalPrice.toString().trim());
    }
