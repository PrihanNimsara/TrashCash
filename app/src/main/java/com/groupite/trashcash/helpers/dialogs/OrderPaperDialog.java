...
public class OrderPaperDialog {
    TextView textViewPaperPrice;
    ...
    private void priceCalculation(String totalWeight, String priceForOneKg){
        ...
        textViewPaperPrice.setText(totalPrice.toString().trim());
    }
    ...
    private void saveData(final String buyerId, final BuyerModel buyerModel){
        ...
        String queryParameter = buyerId+"_"+userId+"_"+ WasteType.PAPER.toString() +"_"+ RequestStatus.ACTIVE.toString();
